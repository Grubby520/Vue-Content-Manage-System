<template>
    <div>
        <div class="handle-box">
            ...
            <!--add/edit dialog-->
            <network-security-service-dialog :dialogVisible="dialogVisible" :tableForm="tableForm" v-if="asyncLoading"  @callbackParent="emitParent"></network-security-service-dialog>
...
<script>
    ...
    import networkSecurityServiceDialog from './networkSecurityService-dialog.vue'
    export default {
        components: {
            networkSecurityServiceDialog
        },
        data(){
          return {
              //查询table的参数
            ...
            * */
            openEditDialog(){
                ...
                if(length === 0){
                    ...
                    Object.assign(this.tableForm, this.multipleSelection[0],{type:'edit',title:'编辑网络安全服务'});
