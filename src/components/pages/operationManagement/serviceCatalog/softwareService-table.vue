<template>
    <div>
        <div class="handle-box">
            ...
            <!--add/edit dialog-->
            <software-service-dialog :dialogVisible="dialogVisible" :tableForm="tableForm" v-if="asyncLoading"  @callbackParent="emitParent"></software-service-dialog>
...
<script>
    ...
    import softwareServiceDialog from './softwareService-dialog.vue'
    export default {
        components: {
            ...
            * */
            openEditDialog(){
                ...
                if(length === 0){
                    ...
                    Object.assign(this.tableForm, this.multipleSelection[0],{type:'edit',title:'编辑软件服务'});
