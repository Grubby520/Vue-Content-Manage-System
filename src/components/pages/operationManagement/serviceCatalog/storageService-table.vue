<template>
    <div>
        <div class="handle-box">
            ...
            <!--add/edit dialog-->
            <storage-service-dialog :dialogVisible="dialogVisible" :tableForm="tableForm" v-if="asyncLoading"  @callbackParent="emitParent"></storage-service-dialog>
            ...
            * */
            openEditDialog(){
                ...
                if(length === 0){
                    ...
                    Object.assign(this.tableForm, this.multipleSelection[0],{type:'edit',title:'编辑存储服务'});
